...
function Accessory() {
    ...
    let count = 0;
    for (let pro of product) if (pro.catalog_id === 55 && pro.catalog_id === 66) count += 1;
        ...
        <ProductPage>
            <nav className="bread-crumb">
                <ul className="breadcrumb">
                    ...
                    <li className="active">Phụ kiện</li>
                </ul>
            </nav>
                            ...
                            <div className="section-product">
                                <div className="row sm-gutter">
                                    {product.map((currentMobile) =>
                                        currentMobile.catalog_id === 44 && currentMobile.catalog_id === 55 ? (
                                            <div
