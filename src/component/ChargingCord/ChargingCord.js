...
function ChargingCord() {
    const { VND, product, addToCart } = useContext(Context);
    let count = 0;
    for (let pro of product) if (pro.catalog_id === 66) count += 1;
        ...
        <ProductPage>
            <nav className="bread-crumb">
                <ul className="breadcrumb">
                    ...
                    <li className="active">Cáp sạc</li>
                </ul>
            </nav>
