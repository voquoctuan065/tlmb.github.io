...
function HeadPhone() {
    ...
    let count = 0;
    for (let pro of product) if (pro.catalog_id === 33) count += 1;
        ...
        <ProductPage>
            <nav className="bread-crumb">
                <ul className="breadcrumb">
                    ...
                    <li className="active">Tai nghe</li>
                </ul>
            </nav>
                        ...
                        <div className="filter-container">
                            ...
                            <aside className="aside-item filter-vendor margin-bottom-10">
                                ...
                                <div className="aside-content filter-group">
                                    <ul>
                                        <LI
                                            filter="filter-duoi500-000d"
                                            type="checkbox"
                                            dataGroup="Khoảng giá"
                                            dataField="price_min"
                                            dataText="Dưới 500.000đ"
                                            dataOperator="OR"
                                            value="<500000"
                                            title="Dưới 500.000đ"
                                        />
                                        <LI
                                            filter="filter-500-000d-1-500-000d"
                                            type="checkbox"
                                            dataGroup="Khoảng giá"
                                            dataField="price_min"
                                            dataText="500.000đ - 1.500.000đ"
                                            dataOperator="OR"
                                            value=">=500000 AND <= 1500000"
                                            title="500.000đ - 1.500.000đ"
                                        />
                                        <LI
                                            filter="filter-1-500-000d-3-000-000d"
                                            type="checkbox"
                                            dataGroup="Khoảng giá"
                                            dataField="price_min"
                                            dataText="1.500.000đ - 3.000.000đ"
                                            dataOperator="OR"
                                            value=">=1500000 AND <= 3000000"
                                            title="1.500.000đ - 3.000.000đ"
                                        />
                                        <LI
                                            filter="filter-3-000-000d-6-000-000d"
                                            type="checkbox"
                                            dataGroup="Khoảng giá"
                                            dataField="price_min"
                                            dataText="3.000.000đ - 6.000.000đ"
                                            dataOperator="OR"
                                            value=">=3000000 AND <= 6000000"
                                            title="3.000.000đ - 6.000.000đ"
                                        />
                                        <LI
                                            filter="filter-tren6-000-000d"
                                            type="checkbox"
                                            dataGroup="Khoảng giá"
                                            dataField="price_min"
                                            dataText="Trên 6.000.000đ"
                                            dataOperator="OR"
                                            value=">6000000"
                                            title="Trên 6.000.000đ"
                                        />
                                    </ul>
                                </div>
                            </aside>
