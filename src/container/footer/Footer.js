    ...
    <div className="footer">
      <div className="footer__start">
        ...
        <div className="regis__notifications">
          <h5 className="footer__start--title">
      ...
      <div className="footer__end">
        <p className="footer__end-content">
          Địa chỉ: số nhà 53, ngõ 8, kiệt 8, Hồ Đắc Di, Phường An Cựu, Thành phố
          Huế, Tỉnh Thừa Thiên - Huế. Tổng đài hỗ trợ: 19001065 - Email:
          cskhtuanlong@gmail.com
        </p>
        <p className="footer__end-content">
          Chịu Trách Nhiệm Quản Lý nội dung: Võ Quốc Tuấn - Điện thoại liên hệ:
          0367268440
        </p>
        <p className="footer__end-content">
          ©2023 - Bản quyền thuộc về TuanLong Mobiles
        </p>
      </div>
    </div>
  );
